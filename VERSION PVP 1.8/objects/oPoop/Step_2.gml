...
if (deadly_timer == 0 && place_meeting(x, y, oPlayer2)) {

	// Damage the player
	if (sprite_index == sPoopGolden) oGamePVP.player2_hp = max(0, oGamePVP.player2_hp - 2);
	else oGamePVP.player2_hp = max(0, oGamePVP.player2_hp - 1);
...
// Hit another poop
} else if (deadly_timer == 0 && place_meeting(x, y, oPoop2)) {
	...
	if (sprite_index == sPoopGolden) {
		...
		var other_poop = instance_place(x, y, oPoop2);
